...
echo -e "\033[1;93m│$NC  AUTO DEL EXPIRED AKUN $sts          $NC" |lolcat
echo -e "\033[1;93m│$NC  AUTO RECOVERY EXPIRED AKUN $sts1          $NC" |lolcat
echo -e "\033[1;93m│$NC  NOTIF EXP VPS $sts2             $NC" |lolcat
echo -e "\033[1;93m└──────────────────────────────────────────┘\033[0m"
echo -e "\033[1;93m┌──────────────────────────────────────────┐\033[0m"
echo -e "\033[1;93m│  ${green}1.${NC} \033[0;36mAUTO DEL ONLY${NC}"|lolcat
echo -e "\033[1;93m│  ${green}2.${NC} \033[0;36mAUTO RECOVERY${NC}"|lolcat
echo -e "\033[1;93m│  ${green}3.${NC} \033[0;36mOFF AUTO TOOL${NC}"|lolcat
echo -e "\033[1;93m│  ${green}4.${NC} \033[0;36mDELET USER EXPIRED${NC}"|lolcat
echo -e "\033[1;93m│  ${green}5.${NC} \033[0;36mON NOTIF EXP VPS${NC}"|lolcat
echo -e "\033[1;93m│  ${green}6.${NC} \033[0;36mOFF NOTIF EXP VPS${NC}"|lolcat
